...
wn = turtle.Screen()
wn.title("Dinosaur Game by @EvolGames")
wn.bgcolor("black")
wn.setup(height=320, width=800)
wn.bgpic(r"C:\Users\welcome\Downloads\background.gif")
wn.tracer(0)

wn.register_shape(r"C:\Users\welcome\Downloads\dinosaur.gif")
wn.register_shape(r"C:\Users\welcome\Downloads\cactus_small.gif")
...
jumper.speed(0)
jumper.shape(r"C:\Users\welcome\Downloads\dinosaur.gif")
jumper.color("green")
jumper.penup()
jumper.dy = 0
jumper.dx = -2
...
obstacle.speed(0)
obstacle.shape(r"C:\Users\welcome\Downloads\cactus_small.gif")
obstacle.color("red")
obstacle.penup()
obstacle.dx = -1
obstacle.height = 30
