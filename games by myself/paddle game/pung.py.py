# Made by Harsh
# @Evol games 
# first ever game made by myself
...
pen.hideturtle()
pen.goto(0,260)
pen.write("Harsh :0  Bivash :0",align="center", font=("courier",24,"bold"))
...
#boader of the game
    ...
    if ball.xcor() > 390:
        ...
        score_a += 1
        pen.clear()
        pen.write("Harsh :{}  Bivash :{}".format(score_a,score_b),align="center", font=("courier",24,"bold"))
