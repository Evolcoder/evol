...
class Ludo:
    ...
    def take_initial_control(self):
        ...
        def operate(ind):
            if ind:
                ...
                def delay_with_instrctions(time_is):
                    ...
                    place_ins['text'] = f"  EvolGames AI will start the within {time_is} sec"
                    place_ins.place(x=20, y=220)

                    if time_is > 5:
                        command_play['text'] = f"             EvolAI Play With Red and You Play With Sky Blue"
        ...
        mvc_btn = Button(top,text="Play With EvolGamesAI",bg="#262626",fg="#00FF00",font=("Arial",15,"bold"),relief=RAISED,bd=3,command=lambda: operate(1), activebackground="#262626")
    ...
    def instruction_btn_sky_blue(self):
        ...
        Label(self.make_canvas, text="Gaurav", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=12,y=15+(40*6+40*3)+40 + 110+50)
    ...
    def instruction_btn_yellow(self):
        ...
        Label(self.make_canvas, text="Sundram", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 +7),y=15+(40*6+40*3)+40 + 110+50)
    ...
    def instruction_btn_green(self):
        ...
        Label(self.make_canvas, text="Ekta", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100+(40*6+40*3+40*6+7), y=15+140+50)
