...
class Ludo:
    ...
    def take_initial_control(self):
        ...
        head = Label(top,text="-:Type no. of players:- ",font=("Arial",25,"bold","italic"),bg="#141414",fg="chocolate")
        ...
        def operate(ind):
            if ind:
                ...
                def delay_with_instrctions(time_is):
                    ...
                    place_ins['text'] = f" Guys your game will start within {time_is} sec"
                    place_ins.place(x=20, y=220)

                    if time_is > 5:
                        command_play['text'] = f"             Harsh Play With Red and Evol AI Play With Sky Blue"
                    elif time_is>= 2 and time_is<5:
                        command_play['text'] = f"                       You Will Get the First Chance to play Harsh"
                    else: 
        ...
        mvc_btn = Button(top,text="Play With Evol AI",bg="#262626",fg="#00FF00",font=("Arial",15,"bold"),relief=RAISED,bd=3,command=lambda: operate(1), activebackground="#262626")
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict Harsh", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
        ...
        Label(self.make_canvas,text="Harsh",bg="#141414",fg="gold",font=("Arial",15,"bold")).place(x=15,y=15+140+50)
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict Shubh",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("sky_blue"))
        ...
        Label(self.make_canvas, text="Shubh", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=12,y=15+(40*6+40*3)+40 + 110+50)
    ...
    def instruction_btn_yellow(self):
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict Gaurav",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        ...
        Label(self.make_canvas, text="Gaurav", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 +7),y=15+(40*6+40*3)+40 + 110+50)
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict Sundram", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("green"))
        ...
        Label(self.make_canvas, text="Sundram", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(x=100+(40*6+40*3+40*6+7), y=15+140+50)
    ...
    def main_controller(self, color_coin, coin_number):
        ...
        if  color_coin == "red":
            ...
            if self.move_red_counter == 106:
                ...
                messagebox.showerror("Wrong choice","Sorry, Your coin in not accepted to travel")
                self.num_btns_state_controller(self.block_value_predict[0][2])
    ...
    def check_winner_and_runner(self,color_coin):
        ...
        if  destination_reached == 1:# If all coins in block reach to the destination, winner and runner check
            ...
            if len(self.total_people_play) == 1:
                messagebox.showinfo("Game Over","Good bye!!!! Thank You for supporting EvolGames by harsh")
...
if __name__ == '__main__':
    ...
    window.title("EvolGames AI by Harsh")
