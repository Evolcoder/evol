...
# Set up the screen
wn = turtle.Screen()
wn.title("Falling Down by @EvolCodes")
wn.bgcolor("black")
wn.bgpic(r"E:\gaming programs\background.gif")
wn.setup(width=800, height=600)
wn.tracer(0)

wn.register_shape(r"E:\gaming programs\deer_left.gif")
wn.register_shape(r"E:\gaming programs\deer_right.gif")
wn.register_shape(r"E:\gaming programs\hunter.gif")
wn.register_shape(r"E:\gaming programs\nut.gif")
...
player.speed(0)
player.shape(r"E:\gaming programs\deer_left.gif")
player.color("white")
player.penup()
player.goto(0, -250)
...
for _ in range(20):
    ...
    good_thing.speed(0)
    good_thing.shape(r"E:\gaming programs\nut.gif")
...
for _ in range(20):
    ...
    bad_thing.speed(0)
    bad_thing.shape(r"E:\gaming programs\hunter.gif")
    bad_thing.color("red")
    bad_thing.penup()
...
def go_right():
    ...
    player.shape(r"E:\gaming programs\deer_right.gif")
